...
static const char *kblayout_cmd[]  = {"pkill", "-RTMIN+10", "someblocks", NULL};
...
static const char *menucmd[] = { "sh", "-c", "dmenu-wl_path | dmenu-wl -p 'RUN' -fn '" _font "' -b -h 30"
																"  -nb '" STR(_inactiveBgColor) 
																"' -nf '" STR(_inactiveTextColor) 
																"' -sb '" STR(_activeBgColor) 
																"' -sf '" STR(_activeTextColor) 
																"'\"$@\" | ${SHELL:-\"/bin/sh\"} &",
																NULL };
...
static const Key keys[] = {
	...
	{ MODKEY|WLR_MODIFIER_CTRL,  XKB_KEY_Down,       moveresizekb,   {.v = (int []){ 0, 40, 0, 0 }}},
	{ MODKEY|WLR_MODIFIER_CTRL,  XKB_KEY_Up,         moveresizekb,   {.v = (int []){ 0, -40, 0, 0 }}},
	{ MODKEY|WLR_MODIFIER_CTRL,  XKB_KEY_Right,      moveresizekb,   {.v = (int []){ 40, 0, 0, 0 }}},
	{ MODKEY|WLR_MODIFIER_CTRL,  XKB_KEY_Left,       moveresizekb,   {.v = (int []){ -40, 0, 0, 0 }}},
	...
	{ MODKEY,                    XKB_KEY_Insert,      togglefloating, {0} },
